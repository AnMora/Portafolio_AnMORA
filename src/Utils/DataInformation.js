const Data = {
    ...
    About: [
        {
            ...
            invitacion: "Te invito a usar la primera opcion 'Enviar Correo' por si deseas comunicarte conmigo.",
    ...
    Education: [
        ...
        },
        {
            ...
            Issued_On_Year: "2019",
            Expired_On: "No caduda",
            Description: "Este documento certifica que el estudiante es un desarrollador web, otorgado por el Instituto Nacional de Aprendizaje (INA) por su conclusion exitosa en periodo de aprendizaje, con un conocimiento competente para ayudar en la creacion de aplicaciones web usando lo aprendido en clases en resumen: levantamiento de requerimientos segun el cliente, estudio e implementacion de sitio web, minutas y establecimiento de contrato para/con los clientes, wireframing (wireframes) y prototyping (mockups), Brackets (Editor de codigo), Sublime Text 3 (Editor de codigo) Instalacion de plugings, HTML 5, CSS 3, Bootstrap (framework), Fetch API en DATA JSON, manejo del DOM JavaScript con AJAX, Breve aprendizaje Angular (Framework), Breve aprendizaje TypeScript, Breve aprendizaje WordPress y Estudio e implementacion sobre accesibilidad web.",
            Level: "Técnico",
            Total_Hours: "1594",
        ...
        },
        {
            ...
            Issued_On_Year: "2018",
            Expired_On: "No caduda",
            Description: "Este documento certifica que el estudiante es un programador de paginas web, otorgado por el Instituto Nacional de Aprendizaje (INA) por su conclusion exitosa en periodo de aprendizaje, con un conocimiento competente para ayudar en la creacion de aplicaciones web usando lo aprendido en clases en resumen: Logica Computacional (Algoritmos), Pseudocodigo, Teoria de factores y fundamentos del diseno grafico para web, HTML 4.1, CSS 3, Dreamweaver (IDE), Introduccion DOM con JavaScript.",
            Level: "Técnico",
            Total_Hours: "294",
            link_name: "No obtenido",
            link_verified: "No obtenido",
    ...
    Certifications: [
        {
            ...
            link_verified: "https://www.udemy.com/certificate/UC-aa12019a-08a7-409f-8980-5250e93a1ae4/",
        ...
        },
        {
            ...
            Total_Classes: "26",
            link_name: "udemy.com/certificate",
            link_verified: "https://www.udemy.com/certificate/UC-78e90621-8f47-44df-a177-d42986f1737a/",
        ...
        },
        {
            ...
            Total_Classes: "16",
            link_name: "udemy.com/certificate",
            link_verified: "https://www.udemy.com/certificate/UC-7149eded-2ea7-4ecf-87a8-0b0cefc4ab3c/",
        ...
        },
        {
            ...
            Total_Classes: "27",
            link_name: "udemy.com/certificate",
            link_verified: "https://www.udemy.com/certificate/UC-5a94fd97-1607-4dbe-b9cf-740d62e8286c/",
    ...
    Pro_Practice: [
        {
            ...
            job_description: "Encargado de Front-End y Back-End bajo asignaturas de SCRUM correspondientes a diferentes proyectos de la academia para mi entrenamiento, investigacion, muestra de avances y manejo de controlador de versiones.",
