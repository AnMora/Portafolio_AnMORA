const Data = {
    ...
    About: [
        {
            ...
            resumen: "Capacitado en nuevas tecnologias, aprendizaje en nuevas herramientas tendencias del mercado y tener proyección de servicios, provisionar los recursos y productos de alta calidad mejora el desempeño que garantiza la funciónalidad y mejoramiento para un crecimiento a mayor nivel de escabilidad.",
    ...
    Education: [
        ...
        },
        {
            ...
            Issued_On_Year: "2019",
            Expired_On: "No caduda",
            Description: "Este documento certifica que el estudiante es un desarrollador web, otorgado por el Instituto Nacional de Aprendizaje (INA) por su conclusion exitosa en periodo de aprendizaje, con un conocimiento competente para ayudar en la creación de aplicaciones web usando lo aprendido en clases en resumen: levantamiento de requerimientos segun el cliente, estudio e implementación de sitio web, minutas y establecimiento de contrato para/con los clientes, wireframing (wireframes) y prototyping (mockups), Brackets (Editor de codigo), Sublime Text 3 (Editor de codigo) Instalación de plugings, HTML 5, CSS 3, Bootstrap (framework), Fetch API en DATA JSON, manejo del DOM JavaScript con AJAX, Breve aprendizaje Angular (Framework), Breve aprendizaje TypeScript, Breve aprendizaje WordPress y Estudio e implementación sobre accesibilidad web.",
            Level: "Técnico",
            Total_Hours: "1594",
        ...
        },
        {
            ...
            Issued_On_Year: "2018",
            Expired_On: "No caduda",
            Description: "Este documento certifica que el estudiante es un programador de paginas web, otorgado por el Instituto Nacional de Aprendizaje (INA) por su conclusion exitosa en periodo de aprendizaje, con un conocimiento competente para ayudar en la creación de aplicaciones web usando lo aprendido en clases en resumen: Logica Computacional (Algoritmos), Pseudocodigo, Teoria de factores y fundamentos del diseno grafico para web, HTML 4.1, CSS 3, Dreamweaver (IDE), Introducción DOM con JavaScript.",
            Level: "Técnico",
            Total_Hours: "294",
            link_name: "No obtenido",
            link_verified: "No obtenido",
